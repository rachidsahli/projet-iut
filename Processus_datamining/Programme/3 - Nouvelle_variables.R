...
base_2022$nb_residences_distinctes <- ifelse(base_2022$nb_residences_distinctes == 1, 
                                             "Residence unique", 
                                             "Residence multiples")
base_2022$nb_residences_distinctes <- as.factor(base_2022$nb_residences_distinctes)

## Modif sur la variable duree_sejour_moyen

base_2022$duree_sejour_moyen <- cut(base_2022$duree_sejour_moyen, 
                                    breaks = c(0, 6, 7, Inf), 
...
base_2022 <- subset(base_2022, select = -c(nationalite,pays_premier_sejour,pays_dernier_sejour,
...
base_2022$duree_sejour_libelle <- ifelse(base_2022$duree_totale_sejours<7,"<1week",
                                         ifelse(base_2022$duree_totale_sejours==7,"1week",">1week"))
